...
const SCHOOL_ADDRESS = "Dindayalpur, Siwan, Bihar - 841226";
...
// ─── Front Card ────────────────────────────────────────────────────────
export const IDCardFront = ({ student, photoUrl, logoUrl, qrUrl, id = "idcard-front" }) => {
  const { personalDetails = {}, academicDetails = {}, contactDetails = {} } = student || {};

  const studentName = personalDetails?.name || personalDetails?.fullName || "ARJUN KUMAR";
  ...
  const admissionNo = personalDetails?.admissionNumber || personalDetails?.studentId || "LFS2025/1023";
  ...
  const effectiveQrUrl = qrUrl || `https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=${encodeURIComponent(defaultQrPayload)}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {logoUrl || schoolLogoImg ? (
            ...
            <div style={{ fontSize: "10px", fontWeight: 800, color: "#061F42", textAlign: "center", lineHeight: 1.1 }}>
              LF<br/>ES
            </div>
          )}
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", flex: 1 }}>
          ...
          <div style={{ width: "100%", height: "1.5px", background: "#C5A059", margin: "3px 0" }} />
          <div
            style={{
              fontSize: "8.5px",
              color: "#E0E6ED",
      ...
      <div style={{ position: "relative", marginTop: "-1px", zIndex: 2 }}>
        <svg width="350" height="24" viewBox="0 0 350 24" fill="none" style={{ display: "block" }}>
          <path d="M0,0 L350,0 L350,6 C230,24 120,24 0,6 Z" fill="#061F42" />
          <path d="M0,6 C120,24 230,24 350,6" stroke="#C5A059" strokeWidth="2.5" fill="none" />
        </svg>
      </div>

      {/* ── Student Information Area (2 Columns) ── */}
      <div style={{ position: "relative", zIndex: 2, padding: "14px 18px 10px 18px", display: "flex", gap: "14px", alignItems: "flex-start" }}>
          ...
          >
            {photoUrl ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#9CA3AF" }}>
                ...
                <span style={{ fontSize: "10px", fontWeight: 700, color: "#6B7280", marginTop: "4px" }}>PHOTO</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              <span style={{ width: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: "#C5A059" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#4B5563", width: "62px", flexShrink: 0 }}>Class</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              ...
              <span style={{ fontWeight: 600, color: "#4B5563", width: "62px", flexShrink: 0 }}>Section</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>
                {section}
              </span>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              <span style={{ width: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: "#C5A059" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M7 8h10"/><path d="M7 12h10"/><path d="M7 16h6"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#4B5563", width: "62px", flexShrink: 0 }}>Roll No.</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>
                {rollNumber}
              </span>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              <span style={{ width: "20px", display: "flex", alignItems: "center", justifyContent: "center", color: "#C5A059" }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="5" width="20" height="14" rx="2"/><path d="M6 10h4"/><path d="M6 14h8"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#4B5563", width: "62px", flexShrink: 0 }}>Adm. No.</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42", fontSize: "10.5px" }}>
                {admissionNo}
              </span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              ...
              <span style={{ fontWeight: 600, color: "#4B5563", width: "62px", flexShrink: 0 }}>DOB</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>
                {dobFormatted}
              </span>
      ...
      <div style={{ position: "relative", zIndex: 2, padding: "10px 24px 12px 24px", display: "flex", alignItems: "flex-end", justifyContent: "space-between", flex: 1 }}>
        {/* QR Code Block */}
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
          <div
            style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
          ...
          <div style={{ width: "130px", borderTop: "1.5px solid #061F42", paddingTop: "3px" }}>
            <span style={{ fontSize: "9.5px", color: "#061F42", fontWeight: 800 }}>Principal Signature</span>
          </div>
        </div>
      </div>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          <div style={{ width: "20px", height: "20px", borderRadius: "50%", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="11" height="11" viewBox="0 0 24 24" fill="#061F42"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"/></svg>
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <span style={{ fontSize: "7.5px", color: "#C5A059", fontWeight: 700, textTransform: "uppercase" }}>School Contact</span>
            <span style={{ fontSize: "10px", color: "#FFFFFF", fontWeight: 800 }}>{SCHOOL_PHONE}</span>
          </div>
        </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          ...
          <span style={{ fontSize: "9.5px", color: "#FFFFFF", fontWeight: 700 }}>{SCHOOL_WEBSITE}</span>
        </div>
      </div>
    </div>
  );
...
export const IDCardBack = ({ student, logoUrl, id = "idcard-back" }) => {
  ...
  const parentName = contactDetails?.parentName || contactDetails?.fatherName || "Rajesh Kumar";
  const emergencyPhone = contactDetails?.parentMobile || contactDetails?.emergencyContact || contactDetails?.phone || SCHOOL_PHONE;
  const bloodGroup = personalDetails?.bloodGroup || "B+";
  const transportMode = personalDetails?.transportMode || "Private";
  const address = contactDetails?.address || "Dindayalpur, Siwan, Bihar - 841226";
  ...
  return (
    ...
    >
      ...
      >
        {/* Gold Ornament */}
        <div style={{ color: "#C5A059", fontSize: "11px", letterSpacing: "3px", marginBottom: "2px" }}>
          — ✤ —
        </div>
        <div
          className="font-cinzel"
      ...
      {/* ── Header Bottom Gold Curved Separator ── */}
      <div style={{ position: "relative", marginTop: "-1px", zIndex: 2 }}>
        <svg width="350" height="22" viewBox="0 0 350 22" fill="none" style={{ display: "block" }}>
          <path d="M0,0 L350,0 L350,6 C230,22 120,22 0,6 Z" fill="#061F42" />
          <path d="M0,6 C120,22 230,22 350,6" stroke="#C5A059" strokeWidth="2.5" fill="none" />
        </svg>
      </div>

      {/* ── Main Content Area ── */}
      <div style={{ position: "relative", zIndex: 2, padding: "12px 20px", flex: 1, display: "flex", flexDirection: "column", gap: "12px" }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "5px", paddingLeft: "4px" }}>
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              <span style={{ width: "18px", color: "#C5A059", display: "flex", alignItems: "center" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#374151", width: "105px" }}>Parent / Guardian</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 700, color: "#061F42" }}>{parentName}</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              ...
              <span style={{ fontWeight: 600, color: "#374151", width: "105px" }}>Contact No.</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>{emergencyPhone}</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "5px", paddingLeft: "4px" }}>
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              <span style={{ width: "18px", color: "#C5A059", display: "flex", alignItems: "center" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a7 7 0 0 0-7 7c0 5.25 7 13 7 13s7-7.75 7-13a7 7 0 0 0-7-7z"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#374151", width: "105px" }}>Blood Group</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>{bloodGroup}</span>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", fontSize: "11px" }}>
              ...
              <span style={{ fontWeight: 600, color: "#374151", width: "105px" }}>Transport</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 800, color: "#061F42" }}>{transportMode}</span>
            </div>

            <div style={{ display: "flex", alignItems: "flex-start", fontSize: "11px" }}>
              <span style={{ width: "18px", color: "#C5A059", display: "flex", alignItems: "center", marginTop: "2px" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
              </span>
              <span style={{ fontWeight: 600, color: "#374151", width: "105px", flexShrink: 0 }}>Address</span>
              <span style={{ fontWeight: 700, color: "#061F42", marginRight: "4px" }}>:</span>
              <span style={{ fontWeight: 700, color: "#061F42", lineHeight: 1.3 }}>{address}</span>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "3px", paddingLeft: "4px", fontSize: "9.5px", color: "#4B5563", fontWeight: 500, lineHeight: 1.35 }}>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "6px" }}>
              <span style={{ color: "#C5A059", fontWeight: 900 }}>•</span>
              <span>This ID card is the property of Little Flower English School.</span>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "6px" }}>
              <span style={{ color: "#C5A059", fontWeight: 900 }}>•</span>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "6px" }}>
              <span style={{ color: "#C5A059", fontWeight: 900 }}>•</span>
              <span>In case of loss, inform the school office immediately.</span>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "6px" }}>
              <span style={{ color: "#C5A059", fontWeight: 900 }}>•</span>
        ...
        <div style={{ marginTop: "auto", display: "flex", justifyContent: "space-between", alignItems: "flex-end", padding: "0 10px" }}>
          <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
            <img
              src={PRINCIPAL_SIGNATURE_IMG}
              alt="Authorised Signatory"
              style={{ height: "28px", maxWidth: "110px", objectFit: "contain", marginBottom: "2px", opacity: 0.9 }}
              crossOrigin="anonymous"
            />
            <div style={{ borderTop: "1px solid #374151", width: "110px", paddingTop: "2px" }}>
              <span style={{ fontSize: "8.5px", fontWeight: 700, color: "#374151" }}>Authorised Signatory</span>
            </div>
          </div>
          ...
          <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center" }}>
            <img
              src={PRINCIPAL_SIGNATURE_IMG}
              alt="Principal"
              style={{ height: "28px", maxWidth: "100px", objectFit: "contain", marginBottom: "2px" }}
              crossOrigin="anonymous"
            />
            <div style={{ borderTop: "1px solid #374151", width: "100px", paddingTop: "2px" }}>
              <span style={{ fontSize: "8.5px", fontWeight: 700, color: "#374151" }}>Principal</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <svg width="13" height="13" viewBox="0 0 24 24" fill="#C5A059"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
        <span style={{ fontSize: "9.5px", color: "#FFFFFF", fontWeight: 700, letterSpacing: "0.3px" }}>
          {SCHOOL_ADDRESS}
        </span>
      </div>
    </div>
...
const StudentIDCard = () => {
  ...
  const handleExportPDF = async () => {
    ...
    try {
      ...
      pdf.save(`ID-Card-${student.personalDetails?.studentId || 'Student'}.pdf`);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 print:hidden bg-white p-4 rounded-2xl shadow-sm border border-gray-100">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{student.personalDetails?.name || student.personalDetails?.fullName}</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Button onClick={handlePrint} className="gap-2 bg-[#061F42] hover:bg-[#0A2E63] text-white">
